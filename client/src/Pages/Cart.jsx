...
const Cart = () => {
  ...
  const handleRemoveFromCart = (id) => {
    if (isUser === true && token)
      dispatch(removeFromCart(id, token)).then((res) => {
      ...
      {isUser && cart.length > 0 ? (
        ...
        >
          <Box
            ...
            textAlign={"left"}
            pl={"10px"}
            m={{ base: "auto", sm: "auto", md: "auto", lg: "px" }}
          >
            <Box bg={"white"} mb={"20px"} p="5px">
              <Text fontWeight={"600"} pl={"20px"}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Box pl={"15px"} textAlign={"left"}>
                        <Text fontWeight={"480"} fontSize={"13.5px"}>
                          {elem.name}
                        </Text>
                        <Text
                          fontWeight={"550"}
                        ...
                        <Text fontWeight={"550"} fontSize={"14px"}>
                          {elem.brand}
                        </Text>
                        <Text fontWeight={"650"} fontSize={"16px"}>
                          ₹ {elem.price}
                        </Text>
                        ...
                        <Flex alignItems={"center"} gap={"5px"}>
                          ...
                          <Button
                            ...
                            fontSize={"13.5px"}
                            disabled={elem.Qty === 1}
                            onClick={() => handleQuantity(elem._id, -1)}
                          >
                            -
                          </Button>
                          <Text
        ...
        >
          ...
          <Button
            bg={"#3470e4 "}
            onClick={handleRedirectToAllProducts}
            mb={"10px"}
            variant={"outline"}
            borderRadius={"0px"}
            color={"white"}
