...
const FilterComponent = ({ page }) => {
  ...
  for (let i = 0; i < appData.length; i++) {
    if (appData[i].category === "Formal") formal++;
    else if (appData[i].category === "Boot") boot++;
  }

  for (let i = 0; i < appData.length; i++) {
    if (appData[i].brand === "WOODLAND") woodland++;
    else if (appData[i].brand === "LEE COOPER") leecoper++;
  }
  ...
  const handleSortPrice = (e) => setSort(e.target.value);
        ...
        <AccordionPanel pb={4} textAlign="left" pl={"15px"}>
          <Box>
            <Checkbox
              ...
              defaultChecked={category.includes("Casual")}
            />
          ...
          {formal > 0 && (
            <Box>
              <Checkbox
                ...
                value={"Formal"}
                onChange={handleCategory}
                defaultChecked={category.includes("Formal")}
              />
          ...
          {boot > 0 && (
            <Box>
              <Checkbox
                ...
                value={"Boot"}
                onChange={handleCategory}
                defaultChecked={category.includes("Boot")}
              />
              <label> Boot</label>
            </Box>
          )}
        ...
        <AccordionPanel pb={4} textAlign="left" pl={"15px"}>
          <Box>
            <Checkbox
              ...
              defaultChecked={brand.includes("REEBOK")}
            />
            <label> Reebok</label>
          </Box>
          <Box>
            <Checkbox
              ...
              value={"ADIDAS"}
              onChange={handleBrand}
              defaultChecked={brand.includes("ADIDAS")}
            />
            <label> Adidas</label>
          </Box>
          <Box>
            <Checkbox
              ...
              value={"Red Chief"}
              onChange={handleBrand}
              defaultChecked={brand.includes("Red Chief")}
            />
          ...
          <Box>
            <Checkbox
              ...
              value={"PUMA"}
              onChange={handleBrand}
              defaultChecked={brand.includes("PUMA")}
            />
            <label> Puma</label>
          </Box>
          <Box>
            <Checkbox
              ...
              value={"NIKE"}
              onChange={handleBrand}
              defaultChecked={brand.includes("NIKE")}
            />
            <label> Nike</label>
          </Box>
          {woodland > 0 && (
            <Box>
              <Checkbox
                ...
                value={"WOODLAND"}
                onChange={handleBrand}
                defaultChecked={brand.includes("WOODLAND")}
              />
          ...
          {leecoper > 0 && (
            <Box>
              <Checkbox
                ...
                value={"LEE COOPER"}
                onChange={handleBrand}
                defaultChecked={brand.includes("LEE COOPER")}
              />
        ...
        <AccordionPanel pb={4} textAlign="left" pl={"15px"}>
          <Box>
            <Checkbox
              ...
              defaultChecked={Rate.includes("3Above")}
            />
            <label> 3 ★ & above</label>
          </Box>
          <Box>
            <Checkbox
              ...
              value={"4Above"}
              onChange={handleRating}
              defaultChecked={Rate.includes("4Above")}
            />
            <label> 4 ★ & above</label>
          </Box>
        </AccordionPanel>
