...
import {
  ...
  ASSIGN_ORDER_DETAILS_TO_USER,
  GET_ORDER_DETAILS_FAILURE,
  GET_ORDER_DETAILS_REQUEST,
  GET_ORDER_DETAILS_SUCCESS,
  REMOVE_FROM_ALL_ORDERS,
...
export const getAllOrderDetails = (token) => (dispatch) => {
  ...
  return axios
    ...
    .then((res) => {
      ...
      return dispatch({ type: GET_ORDER_DETAILS_SUCCESS, payload: res.data.orders });
    })
    .catch((error) => {
...
export const updateOrderStatusByAdmin = (id, newStatus) => (dispatch) => {
  return axios
    .patch(`${process.env.REACT_APP_BASE_URL}/allOrders/${id}`, {
